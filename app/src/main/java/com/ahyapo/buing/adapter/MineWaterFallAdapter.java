...
public class MineWaterFallAdapter extends RecyclerView.Adapter<SimpleViewHolder> {
    private final Context context;
    private String GET_IMAGES_URL;
    private final ArrayList<IndexImages> dataList;
    public MineWaterFallAdapter(Context context, ArrayList<IndexImages> dataList, String url) {
