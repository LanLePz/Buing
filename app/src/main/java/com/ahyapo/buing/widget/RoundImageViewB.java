...
public class RoundImageViewB extends AppCompatImageView {
    ...
    public RoundImageViewB(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initPaint() {
        path = new Path();
        paint = new Paint();
        paint.setColor(R.color.blackbackground);
